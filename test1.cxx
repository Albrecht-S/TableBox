...
int main(int argc, char ** argv) {
    ...
    // row 0
    //             Widget being added                                 row,col  w,h      x,y properties       x,y span  x,y align
    //             -------------------------------------------------- -------  -------  -------------------- --------  -----------
    ...
    table2->begin();
    //             Widget being added                                   row,col  w,h      x,y properties
    //             ---------------------------------------------------- -------  -------  ---------------
    ...
    table3->begin();
    //             Widget being added                                   row,col  w,h      x,y properties           x,y span
    //             ---------------------------------------------------- -------  -------  ------------------------ --------
    ...
    table4->end();
    table1->Attach((Fl_Widget *) table4,                                2, 1,    100, 100, NONE,NONE,     1, 2,    0.5f, 0.5f);
